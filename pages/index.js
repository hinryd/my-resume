...
export default function Home() {
  ...
  return (
    <>
      <button
        className="absolute top-0 left-0 print:hidden bg-yellow-400 p-1 pb-2 pr-2 rounded-br-full"
      ...
      <button
        className="absolute top-0 right-0 print:hidden bg-yellow-400 p-1 pb-2 pl-2 rounded-bl-full"
      ...
      <div className="grid gap-8 p-5 max-w-2xl mx-auto">
        ...
        <section>
          <h3 className="font-bold tracking-widest">CONNECT</h3>
        ...
        <section>
          <h3 className="font-bold tracking-widest">LANGUAGES</h3>
        ...
        <section>
          ...
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="flex gap-1 items-center">
                <AcademicCapIcon className="h-4 w-4 shrink-0 shrink-0" /> BA
                Economics
              </p>
            </div>
        ...
        <section>
          <h3 className="font-bold tracking-widest">INTRODUCTION</h3>
          <p>
        ...
        <section>
          <h3 className="font-bold tracking-widest">TECHNOLOGIES</h3>
        ...
        <section>
          <h3 className="font-bold tracking-widest">EXPERIENCES</h3>
